...
model.load_state_dict(torch.load('./best_model/best_model(anxiety).pth', map_location=device))
model.to(device)
model.eval()
print(model)
...
fig.text(0.5, 0.07, 'Filter Index', ha='center', fontsize=14)

plt.subplots_adjust(wspace=0.1, hspace=0.1)
# Add title for the entire figure
fig.suptitle('Sorted Filter Plot', fontsize=18, y=0.93)
plt.show()
plt.savefig()#change to your directory