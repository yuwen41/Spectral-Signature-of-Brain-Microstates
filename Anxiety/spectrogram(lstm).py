...
for e in range(61):
  ...
  reshaped_non = np.empty((15, 3, 599, 60))
  ...
  # create an empty array
  reshaped_yes = np.empty((15, 3, 599, 60))
  ...
  # create an empty array
  reshaped_all = np.empty((30, 3, 599, 60))
  ...
  for k, (train_index, test_index) in enumerate(kf.split(reshaped_all)):
    ...
    #change the shape of train data from (29,3,60,119) to (29*3,60,119)
    X_train = []
    Y_train = []
    ...
    #change the shape of train data from (1,3,60,119) to (1*3,60,119)
    X_val = []
    Y_val = []
