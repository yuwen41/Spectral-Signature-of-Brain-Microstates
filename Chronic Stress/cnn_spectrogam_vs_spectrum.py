...
#Chronic Stress: spectrogram vs spectrum
spectrogram_stress = pd.read_csv('./results and electrode names(csv)/spectrogram(cnn).csv')#change to your directory
spectrogram_accuracy = spectrogram_stress.iloc[50,:].tolist()#LOOCV accuracy
spectrogram_se = spectrogram_stress.iloc[52,:].tolist()#standard error

spectrum_stress = pd.read_csv('./results and electrode names(csv)/spectrum(cnn).csv')#change to your directory
spectrum_accuracy = spectrum_stress.iloc[50,:].tolist()#LOOCV accuracy
spectrum_se = spectrum_stress.iloc[52,:].tolist()#standard error
...
plt.show()
plt.savefig('./figure/CNN_spectrogram_vs_spectrum.svg', bbox_inches='tight')#your directory